...
{
    [CustomEntity("SS2024/CursedRefill")]
    public class CursedRefill : Refill
    {
        ...
        public CursedRefill(EntityData data, Vector2 offset) : base(data.Position + offset, false, false)
        {
            ...
            sprite = Get<Sprite>();
            Remove(sprite);
            sprite.Reset(GFX.Game, "objects/ss2024/cursedRefill/idle");
            sprite.AddLoop("idle", "", 0.1f);
            sprite.Play("idle");
            flash = Get<Sprite>();
            Remove(flash);
            flash.Reset(GFX.Game, "objects/ss2024/cursedRefill/flash");
            Remove(Get<Image>());
            Add(sprite);
            Add(flash);
            ...
            Add(outline = new Image(GFX.Game["objects/ss2024/cursedRefill/outline"]));
