...
{
    [CustomEntity("SS2024/NoLightClutterSwitch")]
    ...
    [CustomEntity("SS2024/NoShadowClutterController")]
    [Tracked]
    public class NoShadowClutterController : Entity
    {
        public NoShadowClutterController() : base()
        {
        ...
        {
            Color cl = self.color;
            NoShadowClutterController c = self.Scene.Tracker.GetEntity<NoShadowClutterController>();
            if(c != null)
            {
                if (!self.enabled)
                {
